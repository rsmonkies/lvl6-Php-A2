...
#Navigate to remove a category
category_remove_button = driver.find_element(By.CSS_SELECTOR, 'a.btn.btn-primary[href="./Category-Remove.php"]')
#Click Category Remove button
category_remove_button.click()
#Wait for 3 seconds
time.sleep(3)
#Click remove on the category
remove_category = driver.find_element(By.XPATH, '/html/body/div/div/div[2]/div/table/tbody/tr[3]/td[4]/a')
